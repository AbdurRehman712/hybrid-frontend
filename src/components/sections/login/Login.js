            ...
            <section className="login">
                <Container>
                    <Row>
                        <Col md={6}>
                            <h1>Innskráning</h1>
                            <p className="mb-5">Ekki með aðgang? <a className="txt-blue" href="#a">Smelltu hér</a></p>
                            <Form className="mb-5">
                            ...
                            <div className="d-flex justify-content-between">
                                ...
                                <p className="forget"><a className="txt-blue" href="#a">Týnt lykilorð?</a></p>
                            </div>
                        </Col>
                        ...
                        <Col md={5} className="social-login d-flex flex-column justify-content-center align-items-center">
                            <Button variant="outline-light" block><span className="fb"><img src="/assets/images/fb-icon.png" alt="fb-icon" /></span>Innskrá með Facebook</Button>
                            <Button variant="outline-light" block><span className="gm"><img src="/assets/images/gmail-icon.png" alt="gmail-icon" /></span>Innskrá með Google</Button>
                        </Col>
                    </Row>
                </Container>
            </section>
